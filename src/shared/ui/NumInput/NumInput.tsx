...
const NumInput = (props: NumInputProps) => {
	const { value, max, min, increment, bigIncrement, onChange, className, label } = props
	...
	const input = (
		<HStack align='center' gap='8' className={classNames(cls.numInput, {}, [className])}>
			<AiOutlineDoubleLeft onClick={handleBigDecrement} className={cls.icon} />
			...
			<AiOutlineDoubleRight onClick={handleBigIncrement} className={cls.icon} />
		</HStack>
	)
